...
from sendtg.config import DEFAULT_CHAT_ID, DEFAULT_BOT_TOKEN, URL, VERSION
from sendtg.utils.logger import logger as log
...
def run():
    """
    Executes the main functionality of the bot.
    """
    args = cli()
